...
// Kısa bir kutlama melodisi 
int successMelody[] = {
  NOTE_E4, 8, NOTE_E4, 8, NOTE_F4, 8, NOTE_G4, 8,
  NOTE_G4, 8, NOTE_F4, 8, NOTE_E4, 8, NOTE_D4, 8,
  NOTE_C4, 8, NOTE_C4, 8, NOTE_D4, 8, NOTE_E4, 8,
  NOTE_E4, 8, NOTE_D4, 8, NOTE_D4, 4,
  
  NOTE_E4, 8, NOTE_E4, 8, NOTE_F4, 8, NOTE_G4, 8,
  NOTE_G4, 8, NOTE_F4, 8, NOTE_E4, 8, NOTE_D4, 8,
  NOTE_C4, 8, NOTE_C4, 8, NOTE_D4, 8, NOTE_E4, 8,
  NOTE_D4, 8, NOTE_C4, 8, NOTE_C4, 4
};
...
int errorMelody[] = {
  ...
  NOTE_F3, 8, NOTE_C4, 16, NOTE_A3, 4,
  NOTE_F3, 8, NOTE_C4, 16, NOTE_A3, 2,
  
  NOTE_E4, 4, NOTE_E4, 4, NOTE_E4, 4,
  NOTE_F4, 8, NOTE_C4, 16, NOTE_A3, 4,
  NOTE_F3, 8, NOTE_C4, 16, NOTE_A3, 2
};


int successNotes = sizeof(successMelody) / sizeof(successMelody[0]) / 2;
int errorNotes = sizeof(errorMelody) / sizeof(errorMelody[0]) / 2;
...
const char* password = "sky-lab-harika";
#define SS_PIN 15
#define RST_PIN 22
...
void loop() {
  ...
  if (rfid_uid != previous_uid) {
    previous_uid = rfid_uid;
    ...
    if (WiFi.status() == WL_CONNECTED) {
      ...
      if (httpResponseCode > 0) {
        ...
        if (httpResponseCode == 200) {
          ...
          playMelody(errorMelody, errorNotes);
        }
      } else {
        playMelody(errorMelody, errorNotes);
      }
